 ...
 * @e_ident: this is pointer to an array containing the ELF magic numbers.
 *
...
/**
 * print_class - this function rints the class of an ELF header.
...
/**
 * print_data - this function rints the data of an ELF header.
...
/**
 * print_version - this function rints the version of an ELF header.
...
/**
 * print_osabi - this functiion prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * main - this is the entry point of the program that displays
 * the information contained in the ELF header at the start of an ELF file.
